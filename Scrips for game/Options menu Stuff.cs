...
public class OptionsmenuStuff : MonoBehaviour
{
    ...
    private void Start()
    {
         ...
         float musicVol = musicSlider.value = PlayerPrefs.GetFloat("MusicVolume", 0.3f);// saves the players settings, i just put it as 0.3 so the music dont blast yah ears off
